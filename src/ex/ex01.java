...
public class ex01 {
	public static void main(String[] args) {
		...
		if(ans<=t){
		System.out.print("結果為"+ans);	
		}else{
		System.out.print("結果為impossible");	
		}
		x++;
		}
